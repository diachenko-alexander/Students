...
namespace PL
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Create Schedule
            ScheduleDTO scheduleCSharpStarter = new ScheduleDTO { Course = cSharpStarter, Trainer = tr1,  StartDate = new DateTime(2020, 06, 01), FinishDate = new DateTime(2020, 07, 15) };
            ScheduleDTO scheduleCSharpEssential = new ScheduleDTO { Course = cSharpEssential, Trainer = tr1, StartDate = new DateTime(2020, 07, 05), FinishDate = new DateTime(2020, 07, 15) };
